...
//		deleteTest();
	...
	private void setup(){
		...
		Test test2 = new Test(null,"자바 프로개름을 개발하려면 JDK가 반드시 필요하다.",true,"오윤석");
		...
		Test test4 = new Test(null,"자바 프로그램을 실해만 하려면 "+"JRE를 설치해도 상관없다.",true,"오윤석");
		Test test5 = new Test(null,"JVM은 운영체제별로 동일한 JVN이 사용된다.",false,"홍길동");
